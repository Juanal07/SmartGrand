...
//	}
	...
	public void istPersona(Conexion conexion2, String nombre, String apellido, String usuario, String password,
		...
		String insert = "INSERT INTO Personas(nombre, apellido, usuario, password, dni, fecha,tipo) VALUES('" + nombre
	...
	public void crearDb(Conexion conexion2) {
		...
		String tablaTicket = "CREATE TABLE IF NOT EXISTS Ticket("
				...
				+ "Fecha_Paciente Timestamp not NULL, " + "Texto_Medico TEXT, " + "Fecha_Medico Timestamp, "
		...
		String tablaSensor = "CREATE TABLE IF NOT EXISTS Sensor("
				...
				+ "Tipo Date not NULL, " + "Dato INTEGER not NULL, " + "Fecha Date not null, "
	...
	public void leerTickets(ObservableList<TicketsNew> ticketsObservableList, String pWhere, int id) {
		...
		try {
			...
			while (rs.next()) {
				...
				TicketsNew ticketsNew = new TicketsNew(id_tic, texto_Paciente, fecha_Paciente, texto_Medico,
						fecha_Medico, id_medico, id_paciente);
	...
	public void respuestTicket(int idTic, String fechaMedico, String txtMedico) {
